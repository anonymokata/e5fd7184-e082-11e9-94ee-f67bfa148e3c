...
namespace BabysitterKata.Tests {
    ...
    public class CorrectPay {
        ...
        public void FamilyAPay() {
            ...
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(19, 0, 0), new TimeSpan(1, 0, 0)), 100);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(2, 0, 0), new TimeSpan(3, 0, 0)), 20);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(1, 0, 0), new TimeSpan(4, 0, 0)), 60);
        }
        ...
        public void FamilyBPay() {
            ...
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(19, 0, 0), new TimeSpan(1, 0, 0)), 68);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(2, 0, 0), new TimeSpan(3, 0, 0)), 16);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(1, 0, 0), new TimeSpan(4, 0, 0)), 48);
        }
        ...
        public void FamilyCPay() {
            ...
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(19, 0, 0), new TimeSpan(1, 0, 0)), 102);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(2, 0, 0), new TimeSpan(3, 0, 0)), 15);
            Assert.AreEqual(this.sitter.CalculatePay(family, new TimeSpan(1, 0, 0), new TimeSpan(4, 0, 0)), 45);
        }
    }
}
